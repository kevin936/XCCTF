...
return [
    ...
    'http_exception_template' => [
        // 定义404错误的模板文件地址
        404 =>  public_path()."/error/404.html",
        403 =>  public_path()."/error/403.html",
        500 =>  public_path()."/error/500.html",
        502 =>  public_path()."/error/502.html",
        302 =>  public_path()."/error/302.html",
