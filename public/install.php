...
.btn.btn-primary { background-color: #0081ff;}
.btn.btn-primary:hover, .btn.btn-primary:focus { -webkit-animation: none;background-color: #0067cc;}
...
.header .layout .title h2 { font-size: 36px; line-height: 40px; color: #0081ff; display: block; height: 40px;}
...
/* Content section
-------------------------------------- */
.text-box { width: 898px; height: 358px; margin: 0 auto; border: solid 1px #0081ff; position: relative; z-index: 1; overflow: hidden;}
...
.schedule-ico span { display: block; width: 26px; height: 26px; float: left; margin-left: 230px;}
...
.schedule-ico span i.fa{font-size:25px;color:#0081ff}
...
.schedule-line-now { background-color: #4da7ff; height: 8px; -webkit-border-radius: 4px;-moz-border-radius: 4px;-o-border-radius: 4px;border-radius: 4px; position: absolute; z-index: 2; top: 40px; left: 0;}
.schedule-line-now em { FILTER:progid:DXImageTransform.Microsoft.Gradient(gradientType=1, startColorStr='#4da7ff', endColorStr='#ECF0F1')/*IE6-9*/; background-image: -ms-linear-gradient(right, #ECF0F1 0%, #4da7ff 100%)/* IE10 Consumer Preview */; background-image: -moz-linear-gradient(right, #ECF0F1 0%, #4da7ff 100%)/* Mozilla Firefox */; background-image: -o-linear-gradient(right, #ECF0F1 0%, #4da7ff 100%)/* Opera */; background-image: -webkit-gradient(linear, right top, left top, color-stop(0, #ECF0F1), color-stop(1, #4da7ff))/* Webkit (Safari/Chrome 10) */; background-image: -webkit-linear-gradient(right, #ECF0F1 0%, #4da7ff 100%)/* Webkit (Chrome 11+) */; background-image: linear-gradient(to left, #ECF0F1 0%, #4da7ff 100%)/* W3C Markup, IE10 Release Preview */; display: block; width: 60px; height: 8px; float: right;}
...
#step1 .schedule-point-now span.a { background-color: #4da7ff;}
#step1 .schedule-text span.a { font-weight: 600; color: #4da7ff;}
...
#step2 .schedule-point-now span.a, #step2 .schedule-point-now span.b { background-color: #4da7ff;}
#step2 .schedule-text span.a, #step2 .schedule-text span.b { font-weight: 600; color: #4da7ff;}
...
#step3 .schedule-point-now span.a, #step3 .schedule-point-now span.b, #step3 .schedule-point-now span.c { background-color: #4da7ff;}
#step3 .schedule-text span.a, #step3 .schedule-text span.b, #step3 .schedule-text span.c { font-weight: 600; color: #4da7ff;}
...
#step4 .schedule-point-now span.a, #step4 .schedule-point-now span.b, #step4 .schedule-point-now span.c, #step4 .schedule-point-now span.d { background-color: #4da7ff;}
#step4 .schedule-text span.a, #step4 .schedule-text span.b, #step4 .schedule-text span.c, #step4 .schedule-text span.d { font-weight: 600; color: #4da7ff;}
...
.select-module ul li .ico { width: 96px; height: 96px; margin: 30px auto 0 auto;font-size: 7em;}
...
.select-module ul li h4 { font-size: 16px; font-weight: 600; line-height: 24px; color: #4da7ff; text-align: center; margin-top: 10px;}
...
.content-box table th[scope="col"] { font-size: 14px; line-height: 24px; color: #FFF; background-color: #4da7ff; text-align: left; height: 20px; padding: 7px 1%;}
...
<div class="main">
  <div class="step-box" id="step1">
    ...
    <div class="procedure-nav">
      <div class="schedule-ico"><span class="a"><i class="fa fa-binoculars"></i></span><span class="b"><i class="fa fa-grav" style="color:#ECF0F1"></i></span><span class="c"><i class="fa fa-database" style="color:#ECF0F1"></i></span><span class="d"><i class="fa fa-check" style="color:#ECF0F1"></i></span></div>
...
<div class="main">
  <div class="step-box" id="step2">
    ...
    <div class="procedure-nav">
      <div class="schedule-ico"><span class="a"><i class="fa fa-binoculars"></i></span><span class="b"><i class="fa fa-grav"></i></span><span class="c"><i class="fa fa-database" style="color:#ECF0F1"></i></span><span class="d"><i class="fa fa-check" style="color:#ECF0F1"></i></span></div>
      <div class="schedule-point-now"><span class="a"></span><span class="b"></span><span class="c"></span><span class="d"></span></div>
      <div class="schedule-point-bg"><span class="a"></span><span class="b"></span><span class="c"></span><span class="d"></span></div>
      <div class="schedule-line-now"><em></em></div>
      <div class="schedule-line-bg"></div>
  ...
  <input type="hidden" value="3" name="step">
    <div class="select-install">
      <label>
      <input type="radio" name="iCheck" value="full" id="radio-1" checked>
      <h4>完全安装 {$site_name}</h4>
      <h4>系统</h4>
     
      </label>
    </div>
    <div class="select-module" id="result" style="">
      <div class="arrow"></div>
      <ul>
        <li class="cms">
          <input type="checkbox" name="cms" id="cms" value="1" checked="checked"  disabled="">
          <div class="ico"><i class="fa fa-optin-monster"></i></div>
          <h4>CTF靶场</h4>
          <p>CTF靶场实现各种CTF题型静态、动态flag提交...</p>
        </li>
        <li class="shop">
          <input type="checkbox" name="shop" id="shop" value="1" checked="checked" disabled="">
          <div class="ico"><i class="fa fa-wordpress"></i></div>
          <h4>博客</h4>
          <p>博客圈子，为用户提供基础的博客功能实现技术文章分享...</p>
        </li>
        <li class="circle">
          <input type="checkbox" name="circle" value="1" checked="checked" disabled="">
          <div class="ico"><i class="fa fa-linux "></i></div>
          <h4>AWD</h4>
          <p>CTF另外一模块AWD攻防竞赛模式...</p>
        </li>
        <li class="microshop">
          <input type="checkbox" name="microshop" value="1" checked="checked" disabled="">
          <div class="ico"><i class="fa fa-user-secret"></i></div>
          <h4>战队</h4>
          <p>实现用户可以基于个体或团队进行竞赛...</p>
        </li>
      </ul>
    </div>
...
EOF;
    ...
    case 3:
        ...
        $db_name = $_POST['db_name'] ?? 'database';
        $db_user = $_POST['db_user'] ?? '';
        $db_pwd = $_POST['db_pwd'] ?? '';
        $db_prefix = $_POST['db_prefix'] ?? 'tp_';
...
<div class="main">
  <div class="step-box" id="step3">
    ...
    <div class="procedure-nav">
      <div class="schedule-ico"><span class="a"><i class="fa fa-binoculars"></i></span><span class="b"><i class="fa fa-grav"></i></span><span class="c"><i class="fa fa-database"></i></span><span class="d"><i class="fa fa-check" style="color:#ECF0F1"></i></span></div>
      <div class="schedule-point-now"><span class="a"></span><span class="b"></span><span class="c"></span><span class="d"></span></div>
      <div class="schedule-point-bg"><span class="a"></span><span class="b"></span><span class="c"></span><span class="d"></span></div>
      <div class="schedule-line-now"><em></em></div>
      <div class="schedule-line-bg"></div>
...
<div class="main">
  <div class="text-box" id="text-box">
    <div class="license">
      <h1>系统安装协议</h1>
      <p>感谢您选择本系统。本系统是集CTF靶场、博客、AWD、战队，在线工具等的CTF平台解决方案。官方网址为 {$site_url}。</p>
      <p>用户须知：本协议是您与{$site_name}交流中心之间关于您安装使用{$site_name}团队提供的{$site_name}系统及服务的法律协议。无论您是个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议。请您审阅并接受或不接受本协议条款。如您不同意本协议条款或{$site_name}团队随时对其的修改，您应不使用或主动取消{$site_name}团队提供的{$site_name}系统。否则，您的任何对{$site_name}系统使用的行为将被视为您对本服务条款全部的完全接受，包括接受{$site_name}对服务条款随时所做的任何修改。</p>
      <p>本服务条款一旦发生变更，{$site_name}团队将在网页上公布修改内容。修改后的服务条款一旦在网页上公布即有效代替原来的服务条款。如果您选择接受本条款，即表示您同意接受协议各项条件的约束。如果您不同意本服务条款，则不能获得使用本服务的权利。您若有违反本条款规定，{$site_name}团队有权随时中止或终止您对{$site_name}系统的使用资格并保留追究相关法律责任的权利。</p>
      <p>在理解、同意、并遵守本协议的全部条款后，方可开始使用{$site_name}系统。您可能与{$site_name}团队直接签订另一书面协议，以补充或者取代本协议的全部或者任何部分。</p>
      ...
      <ol>
        ...
        <li>您拥有使用本软件构建的网站中全部会员资料、题目、商品及相关信息的所有权，并独立承担与使用本软件构建的网站内容的审核、注意义务，确保其不侵犯任何人的合法权益，独立承担因使用{$site_name}系统和服务带来的全部责任，若造成{$site_name}或用户损失的，您应予以全部赔偿。</li>
        <li>本协议是您与{$site_name}团队之间关于您安装使用{$site_name}团队提供的{$site_name}系统及服务的法律协议，若您需将{$site_name}系统或服务用于商业用途，必须另行获得{$site_name}的授权许可，您在获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持期限、技术支持方式和技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权利，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。</li>
      </ol>
      <p></p>
      <h3>II. 协议规定的约束和限制</h3>
      <ol>
        <li>未获{$site_name}团队商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登录{$site_url}参考相关说明，也可以致邮root_1024@163.com了解详情。</li>
      ...
      <ol>
        ...
        <li>{$site_name}团队不对使用本软件构建的平台中的会员、商品或文章信息承担责任，全部责任由您自行承担。</li>
        <li>{$site_name}团队对提供的软件和服务之及时性、安全性、准确性不作担保，由于不可抗力因素、{$site_name}团队无法控制的因素（包括黑客攻击、停断电等）等造成软件使用和服务中止或终止，而给您造成损失的，您同意放弃追究{$site_name}团队责任的全部权利。</li>
        <li>{$site_name}团队特别提请您注意，{$site_name}团队为了保障团队业务发展和调整的自主权，{$site_name}团队拥有随时经或未经事先通知而修改服务内容、中止或终止部分或全部软件使用和服务的权利，修改会公布于{$site_name}团队网站相关页面上，一经公布视为通知。{$site_name}团队行使修改或中止、终止部分或全部软件使用和服务的权利而造成损失的，{$site_name}团队不需对您或任何第三方负责。</li>
      </ol>
      <p></p>
      <p>有关{$site_name}系统最终用户授权协议、商业授权与技术服务的详细内容，均由{$site_name}团队独家提供。{$site_name}团队拥有在不事先通知的情况下，修改授权协议和服务价目表的权利，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>
...
<div class="main">
  <div class="step-box" id="step4">
    ...
    <div class="procedure-nav">
      <div class="schedule-ico"><span class="a"><i class="fa fa-binoculars"></i></span><span class="b"><i class="fa fa-grav"></i></span><span class="c"><i class="fa fa-database"></i></span><span class="d"><i class="fa fa-check"></i></span></div>
      <div class="schedule-point-now"><span class="a"></span><span class="b"></span><span class="c"></span><span class="d"></span></div>
      <div class="schedule-point-bg"><span class="a"></span><span class="b"></span><span class="c"></span><span class="d"></span></div>
      <div class="schedule-line-now"><em></em></div>
      <div class="schedule-line-bg"></div>
